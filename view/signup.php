...
<div class="form">
    <h3>Đăng kí thành viên</h1>
        <form action="#" onsubmit="return KiemTra()" method="post" id="formdangky">
            <div class="form-group">
                <img id="file-1" src="asset/icons/register-file.png" alt="register-file">
            ...
            <div class="form-group">
                <label for="text">Tiếu sử bệnh</label> <br>
                <textarea name="text" id="text-area"></textarea>
                <div id="error6" class="error"></div>
            </div>
            <div class="form-group">
                <label for="text">Mô tả bệnh</label> <br>
                <textarea name="text" id="text-area"></textarea>
            ...
            <div class="form-group">
                ...
                <img id="file-2" src="asset/icons/register-file.png" alt="register-file">
            </div>
        </form>
</div>
